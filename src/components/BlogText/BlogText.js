...
import Image2 from "../../images/post-12.jpg";
import "./BlogText.css";
const BlogText = () => {
  return (
    <section className="blog-area">
      <Container>
        <div className="row ml-xl-0 mr-xl-n6">
          <div className="col-lg-8 mb-lg-0 pl-xl-0 pr-xl-6 mb-0">
            {/* card1 */}
            <div className="card1 boder-0 pb-6 mb-6 boder-bottom">
              ...
              <div className="text-div">
                ...
                <button className="btn-text mb-5">Read More</button>
              </div>
            </div>
            {/* card 2 */}
          ...
          <div
            className=" col-lg-4 mb-6 mb-lg-0 mb-5 mt-0 primary-sidebar sidebar-sticky sidebar-mobile-hide"
            id="sidebar"
          >
                  ...
                  <form>
                    <div className="position-relative">
                      <input
                        ...
                        placeholder="Search..."
                        name="search"
                        className="from-control from-control-lg boder-0 shawo-none"
                      />
                ...
                <div className="card-body px-6 pt-5 pb-6">
                  ...
                  <ul className="list-inline mb-0">
                    ...
                    <li className="list-inline-item mb-2">
                      <a
                        href="#/"
                        clasName="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded"
                      >
                        videos
                      </a>
                    </li>
